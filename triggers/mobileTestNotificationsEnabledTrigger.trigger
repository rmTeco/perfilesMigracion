trigger mobileTestNotificationsEnabledTrigger on Opportunity (after update, after insert) {
    ...
    for(Opportunity cs : Trigger.New)  
    {
        ...
        Map<String, Object> applePayload = 
            Messaging.PushNotificationPayload.apple(
                'iOS: Case ' + cs.name + ' Notificaciones: ' 
        ...
        //        + cs.name);
        androidPayload.put('message', 'Notificaciones!');
        ...
        //listaId = [Select id from User where Receive_Notifications__c=true]; 
