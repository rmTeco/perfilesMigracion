...
baseCtrl.prototype.filterProductHierarchy = function(product) {
    if (product.children) {
        ...
        $scope.init = function(){
            $scope.bpTree.response.AssetSelection.selectedAssets = [];
        }
        
        $scope.saveSelectedAsset = function(asset){
            if (asset.vlcSelected) {
               $scope.bpTree.response.AssetSelection.selectedAssets.push(asset);
            }
            else {
                $scope.bpTree.response.AssetSelection.selectedAssets.pop(asset);
            }
        }
